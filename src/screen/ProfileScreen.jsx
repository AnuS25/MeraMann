...
//   //     if (token) {
//   //       const response = await axios.post('http://10.0.2.2:5001/userdata', {token});
...
//     console.log(token);
//     axios
//       .post('https://mentalapp-backend.onrender.com/userdata', {token: token})
//       .then(res => {
...
//  const UserInfo = ({iconComponent, title, value, iconBgColor}) => (
//     <View style={styles.infoMain}>
//       <View style={styles.infoCont}>
//         <View style={[styles.infoIconCont, {backgroundColor: iconBgColor}]}>
//           {iconComponent}
//         </View>
//         <View style={styles.infoText}>
//           <Text style={styles.infoSmall_Text}>{title}</Text>
...
//     const token = await AsyncStorage.getItem('token');
//     // Call your backend API to log out (invalidate the session or token)
//     fetch('https://mentalapp-backend.onrender.com/logout', {
//         method: 'POST',
//         headers: {
...
//         .then((data) => {
//             if (data.success) {
//                 // On success, navigate to the login screen or home
