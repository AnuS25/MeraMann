...
const SignupScreen = () => {
  ...
  return (
    ...
    <View style={styles.radiobutton_div}>
      <Text styles={styles.radiobutton_title}>Login as</Text>
      <View style={styles.radiobutton_inner_div}>
        <Text style={styles.radiobutton_text}>User</Text>
        <RadioButton value='User' status={usertype=="User"?'checked':'unchecked'} 
          onPress={()=>setusertype('User')}
        />
      </View>
      <View style={styles.radiobutton_inner_div}>
        <Text style={styles.radiobutton_text}>Admin</Text>
        <RadioButton value='Admin' status={usertype=="Admin"?'checked':'unchecked'}
